...
public:
	inline number* operator[](size_t const i) { return data() + i * x_size; }
	inline number const* operator[](size_t const i) const { return data() + i * x_size; }
	inline number* at(size_t const i) { return operator[](i); }
	inline number const* at(size_t const i) const { operator[](i); }
